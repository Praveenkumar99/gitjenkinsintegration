...
class Volte_updown_mt:
    ...
    def execute_volte_updown(self):
        ...
        status, msg = ui.upgrade_call(self.Data['testcase_config'][self.tst]['tempDevicesId'][0])
        ...
        status, msg = ui.acceptVT_call(self.Data['serialId'])
        ...
        time.sleep(1)
        status, msg = ui.downgrade_call(deviceId=self.Data['testcase_config'][self.tst]['tempDevicesId'][0])
