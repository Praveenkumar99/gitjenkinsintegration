...
class SwappingCall:
    ...
    def execute_call(self):
        ...
        log.info("==Performing a VT call from A to B==")
        ...
        log.info("==Performing a VT call from A to C keeping A and B VT call on hold==")
        ...
        # Receiving the VT Call in Devices C
        if mCallState != adb.CallStates.INCOMING_CALL.value:
...
def vt_call_swap_1(tst, yamlData):
